...
public class MainActivity<isMusicPlayerInit> extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        if (!isMusicPlayerInit) {
            ...
            final TextView songDurationTextiew = findViewById(R.id.songDuration);
            listView.setOnItemClickListener(new AdapterView.OnItemClickListener(){
                ...
                public void onItemClick(AdapterView<?> parent,View view,int position,long id){
                    ...
                    songDurationTextiew.setText(String.valueOf(songDuration/60+":"+String.valueOf(songDuration%60)));
                    new Thread(){
                        public void run(){
                            songPosition = 0;
